...
func NewUpdateHandler(st store.Store) *UpdateHandler {
...
func (h *UpdateHandler) GetLatestUpdate(w http.ResponseWriter, r *http.Request) {
	...
	manifest, err := h.buildManifest("1.1.0", platform, track, claims.OrganizationID.String())
	if err != nil {
...
func (h *UpdateHandler) GetVersionManifest(w http.ResponseWriter, r *http.Request) {
	...
	manifest, err := h.buildManifest(version, platform, track, claims.OrganizationID.String())
	if err != nil {
...
func (h *UpdateHandler) buildManifest(version, platform, track, orgID string) (*AgentUpdateManifest, error) {
	...
	pkg := UpdatePackage{
		...
		SHA256Hex:     computeFakeSHA256(version, platform),
		SizeBytes:     8_547_328,
